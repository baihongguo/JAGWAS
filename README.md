...
--cor_matrix
  A text file including the correlation matrix of the phenotypes (estimated by the residuals of a LM/LMM), and the order of the phenotypes in the correlation matrix should match with the order of the summary statistics files in the input command. 
